...
pub use bool_primitives::{AccountId, Signature};
use bool_primitives::{AccountIndex, Balance, BlockNumber, Hash, Index, Moment};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("bool-node"),
	impl_name: create_runtime_str!("bool-node"),
...
impl pallet_thresh::Trait for Runtime {
	type Event = Event;
	type Currency = Balances;
}
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = bool_primitives::Block,
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Thresh: pallet_thresh::{Module, Call, Storage, Event<T>},
	}
);
